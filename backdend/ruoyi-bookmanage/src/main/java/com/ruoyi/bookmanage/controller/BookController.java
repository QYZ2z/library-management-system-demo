...
import com.ruoyi.bookmanage.service.IBookService;
 ...
 */
@RestController
@RequestMapping("/bookmanage/book")
public class BookController extends BaseController
{
     ...
     * 查询书籍管理列表
     */
    @PreAuthorize("@ss.hasPermi('bookmanage:book:list')")
    @GetMapping("/list")
     ...
     * 导出书籍管理列表
     */
    @PreAuthorize("@ss.hasPermi('bookmanage:book:export')")
     ...
     * 获取书籍管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('bookmanage:book:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增书籍管理
     */
    @PreAuthorize("@ss.hasPermi('bookmanage:book:add')")
     ...
     * 修改书籍管理
     */
    @PreAuthorize("@ss.hasPermi('bookmanage:book:edit')")
     ...
     * 删除书籍管理
     */
    @PreAuthorize("@ss.hasPermi('bookmanage:book:remove')")
