...
import com.ruoyi.bookmanage.domain.Region;
import com.ruoyi.bookmanage.service.IRegionService;
 ...
 */
@RestController
@RequestMapping("/bookmanage/region")
public class RegionController extends BaseController
{
     ...
     * 查询区域管理列表
     */
    @PreAuthorize("@ss.hasPermi('bookmanage:region:list')")
    @GetMapping("/list")
     ...
     * 导出区域管理列表
     */
    @PreAuthorize("@ss.hasPermi('bookmanage:region:export')")
     ...
     * 获取区域管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('bookmanage:region:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增区域管理
     */
    @PreAuthorize("@ss.hasPermi('bookmanage:region:add')")
     ...
     * 修改区域管理
     */
    @PreAuthorize("@ss.hasPermi('bookmanage:region:edit')")
     ...
     * 删除区域管理
     */
    @PreAuthorize("@ss.hasPermi('bookmanage:region:remove')")
